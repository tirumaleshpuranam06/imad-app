...
app.get('/Personnal_Background',function(req,res){
 res.send('Personnal_Background Requested and will be Served Here');
});

app.get('/Education_Background',function(req,res){
